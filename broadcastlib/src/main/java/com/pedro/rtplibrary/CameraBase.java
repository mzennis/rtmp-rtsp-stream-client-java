...
import com.pedro.encoder.input.video.CameraApiManager;
...
public abstract class CameraBase implements AudioEncoderListener, VideoEncoderListener, MicrophoneListener {
   ...
   */
  @Deprecated
  public CameraBase(SurfaceView surfaceView) {
  ...
  public CameraBase(OpenGlView openGlView) {
  ...
  public CameraBase(LightOpenGlView lightOpenGlView) {
  ...
  public CameraBase(Context context, boolean useOpengl) {
   ...
   * Experimental
   */
  public void enableFaceDetection(CameraApiManager.FaceDetectorCallback faceDetectorCallback) {
